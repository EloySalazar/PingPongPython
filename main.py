...
icono = pygame.image.load("assets/ico.png")
...
player1_img = pygame.image.load('assets/paddle.png')
player2_img = pygame.image.load('assets/paddle.png')
...
while run:
    ...
    if ball.colliderect(player1) or ball.colliderect(player2):
        ...
        speed += 100
        #print(speed)
    blueMarker = font.render(str(scoreBlue),0,(172,252,28))
    redMarker = font.render(str(scoreRed),0,(172,252,28))
